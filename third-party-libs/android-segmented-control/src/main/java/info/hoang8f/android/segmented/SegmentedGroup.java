...
public class SegmentedGroup extends RadioGroup {
    ...
    private int SELECTED_LAYOUT = R.drawable.radio_checked;
    private int UNSELECTED_LAYOUT = R.drawable.radio_unchecked;
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            ...
            SELECTED_LAYOUT = typedArray.getResourceId(R.styleable.SegmentedGroup_sc_selected_layout, R.drawable.radio_checked);
            UNSELECTED_LAYOUT = typedArray.getResourceId(R.styleable.SegmentedGroup_sc_unselected_layout, R.drawable.radio_unchecked);
        } finally {
            typedArray.recycle();
        }
    }
    ...
    private void updateBackground(View view) {
        int checked = getSelected();
        int unchecked = getUnselected();
        //Set text color
