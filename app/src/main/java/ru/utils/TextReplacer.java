...
public class TextReplacer
{
    ...
    public static CharSequence replace(CharSequence source, String regex, CharSequence replacement)
    {
        ...
        return new TextReplacer(source, matcher, replacement).doReplace();
    }

    private TextReplacer(CharSequence source, Matcher matcher, CharSequence replacement)
    {
        mSource = source;
    ...
    private void appendReplacement(SpannableStringBuilder buffer)
    {
        ...
        CharSequence replacement = mIsSpannable ? copyCharSequenceWithSpans(mReplacement) : mReplacement;
